        ...
        <div class="flex flex-col lg:flex-row mx-30 py-20 gap-12">
            <div class="flex flex-col lg:flex-row gap-8">
                <div class="flex flex-col gap-4">
                    <a href=""><img src="../assets/images/videos_section/video_1.jpg" alt="Video 1" class="lg:w-378"></a>                        
                </div>
                <div class="flex flex-col gap-4">
                    <a href=""><img src="../assets/images/videos_section/video_2.jpg" alt="Video 2" class="lg:w-378"></a>
                </div>
                <div class="flex flex-col gap-4">
                    <a href=""><img src="../assets/images/videos_section/video_3.jpg" alt="Video 3" class="lg:w-378"></a>
                </div>
            </div>                
        </div>
